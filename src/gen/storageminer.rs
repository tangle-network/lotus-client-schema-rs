...
pub struct RemoteSectorMeta {
    ...
    pub pre_commit_tip_set: Vec<Cid>,
...
pub trait StorageMinerApi {
    ...
    async fn check_provable(
        ...
        sector_refs: Vec<SectorRef>,
    ) -> Result<HashMap<u64, String>, Error>;
    async fn closing(&self) -> Result<mpsc::Receiver<()>, Error>;
    async fn compute_data_cid(
        &self,
        unpadded_piece_size: u64,
        reader: Value,
    ) -> Result<PieceInfo, Error>;
    async fn compute_proof(
        &self,
        extended_sector_infos: Vec<ExtendedSectorInfo>,
        uint8s: Vec<u8>,
        chain_epoch: i64,
        version: u32,
    ) -> Result<Vec<PoStProof>, Error>;
    async fn compute_window_po_st(
        &self,
        uint64: u64,
        tip_set_key: Vec<Cid>,
    ) -> Result<Vec<SubmitWindowedPoStParams>, Error>;
    ...
    async fn return_add_piece(
        ...
        call_error: Option<CallError>,
    ) -> Result<(), Error>;
    async fn return_data_cid(
        &self,
        call_id: CallID,
        piece_info: PieceInfo,
        call_error: Option<CallError>,
    ) -> Result<(), Error>;
    async fn return_download_sector(
        &self,
        call_id: CallID,
        call_error: Option<CallError>,
    ) -> Result<(), Error>;
    ...
    async fn return_replica_update(
        &self,
        call_id: CallID,
        replica_update_out: ReplicaUpdateOut,
        call_error: Option<CallError>,
    ) -> Result<(), Error>;
    ...
    async fn sector_add_piece_to_any(
        ...
        unpadded_piece_size: u64,
        reader: Value,
        piece_deal_info: PieceDealInfo,
    ) -> Result<SectorOffset, Error>;
    ...
    async fn sector_num_reserve(
        &self,
        string: String,
        bit_field: BitField,
        bool: bool,
    ) -> Result<(), Error>;
    async fn sector_num_reserve_count(
        &self,
        string: String,
        uint64: u64,
    ...
    async fn storage_attach(&self, storage_info: StorageInfo, fs_stat: FsStat)
        -> Result<(), Error>;
    ...
    async fn storage_find_sector(
        ...
        sector_size: u64,
        bool: bool,
    ) -> Result<Vec<SectorStorageInfo>, Error>;
...
impl StorageMinerApi for StorageMinerClient {
    ...
    async fn actor_address_config(&self) -> Result<AddressConfig, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.ActorAddressConfig", params)
            .await
    }
    ...
    async fn actor_sector_size(&self, address: String) -> Result<u64, Error> {
        ...
        self.client
            .request("Filecoin.ActorSectorSize", params)
            .await
    }

    async fn actor_withdraw_balance(&self, int: String) -> Result<Cid, Error> {
        let params =
            vec![serde_json::to_value(&int).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.ActorWithdrawBalance", params)
            .await
    }
    ...
    async fn beneficiary_withdraw_balance(&self, int: String) -> Result<Cid, Error> {
        let params =
            vec![serde_json::to_value(&int).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.BeneficiaryWithdrawBalance", params)
            .await
    }
    ...
    async fn compute_proof(
        ...
        let params = vec![
            serde_json::to_value(&extended_sector_infos)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
    ...
    async fn compute_window_po_st(
        ...
        self.client
            .request("Filecoin.ComputeWindowPoSt", params)
            .await
    }
    ...
    async fn market_list_deals(&self) -> Result<Vec<Option<MarketDeal>>, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.MarketListDeals", params)
            .await
    }
    ...
    async fn recover_fault(&self, sector_numbers: Vec<u64>) -> Result<Vec<Cid>, Error> {
        let params = vec![serde_json::to_value(&sector_numbers)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
    ...
    async fn return_add_piece(
        ...
        self.client
            .request::<()>("Filecoin.ReturnAddPiece", params)
            .await
    }
    ...
    async fn return_data_cid(
        ...
        self.client
            .request::<()>("Filecoin.ReturnDataCid", params)
            .await
    }
    ...
    async fn return_download_sector(
        ...
        self.client
            .request::<()>("Filecoin.ReturnDownloadSector", params)
            .await
    }
    ...
    async fn return_fetch(
        ...
        self.client
            .request::<()>("Filecoin.ReturnFetch", params)
            .await
    }
    ...
    async fn return_finalize_replica_update(
        ...
        self.client
            .request::<()>("Filecoin.ReturnFinalizeReplicaUpdate", params)
            .await
    }
    ...
    async fn return_finalize_sector(
        ...
        self.client
            .request::<()>("Filecoin.ReturnFinalizeSector", params)
            .await
    }
    ...
    async fn return_generate_sector_key_from_data(
        ...
        self.client
            .request::<()>("Filecoin.ReturnGenerateSectorKeyFromData", params)
            .await
    }
    ...
    async fn return_move_storage(
        ...
        self.client
            .request::<()>("Filecoin.ReturnMoveStorage", params)
            .await
    }
    ...
    async fn return_prove_replica_update1(
        ...
        self.client
            .request::<()>("Filecoin.ReturnProveReplicaUpdate1", params)
            .await
    }
    ...
    async fn return_prove_replica_update2(
        ...
        self.client
            .request::<()>("Filecoin.ReturnProveReplicaUpdate2", params)
            .await
    }
    ...
    async fn return_read_piece(
        ...
        self.client
            .request::<()>("Filecoin.ReturnReadPiece", params)
            .await
    }
    ...
    async fn return_release_unsealed(
        ...
        self.client
            .request::<()>("Filecoin.ReturnReleaseUnsealed", params)
            .await
    }
    ...
    async fn return_replica_update(
        ...
        let params = vec![
            serde_json::to_value(&call_id).map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&replica_update_out)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&call_error).map_err(|e| Error::invalid_params(e.to_string()))?,
        ];
        self.client
            .request::<()>("Filecoin.ReturnReplicaUpdate", params)
            .await
    }
    ...
    async fn return_seal_commit1(
        ...
        self.client
            .request::<()>("Filecoin.ReturnSealCommit1", params)
            .await
    }
    ...
    async fn return_seal_commit2(
        ...
        self.client
            .request::<()>("Filecoin.ReturnSealCommit2", params)
            .await
    }
    ...
    async fn return_seal_pre_commit1(
        ...
        self.client
            .request::<()>("Filecoin.ReturnSealPreCommit1", params)
            .await
    }
    ...
    async fn return_seal_pre_commit2(
        ...
        self.client
            .request::<()>("Filecoin.ReturnSealPreCommit2", params)
            .await
    }
    ...
    async fn return_unseal_piece(
        ...
        self.client
            .request::<()>("Filecoin.ReturnUnsealPiece", params)
            .await
    }
    ...
    async fn runtime_subsystems(&self) -> Result<Vec<i32>, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.RuntimeSubsystems", params)
            .await
    }

    async fn sealing_abort(&self, call_id: CallID) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&call_id).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.SealingAbort", params)
            .await
    }

    async fn sealing_remove_request(&self, uuid: [u8; 16]) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&uuid).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.SealingRemoveRequest", params)
            .await
    }
    ...
    async fn sealing_sched_diag(&self, bool: bool) -> Result<Value, Error> {
        ...
        self.client
            .request("Filecoin.SealingSchedDiag", params)
            .await
    }

    async fn sector_abort_upgrade(&self, sector_number: u64) -> Result<(), Error> {
        let params = vec![serde_json::to_value(&sector_number)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.SectorAbortUpgrade", params)
            .await
    }
    ...
    async fn sector_add_piece_to_any(
        ...
        let params = vec![
            serde_json::to_value(&unpadded_piece_size)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&reader).map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&piece_deal_info)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
        ];
        self.client
            .request("Filecoin.SectorAddPieceToAny", params)
            .await
    }
    ...
    async fn sector_commit_flush(&self) -> Result<Vec<CommitBatchRes>, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.SectorCommitFlush", params)
            .await
    }
    ...
    async fn sector_commit_pending(&self) -> Result<Vec<SectorID>, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.SectorCommitPending", params)
            .await
    }
    ...
    async fn sector_get_expected_seal_duration(&self) -> Result<i64, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.SectorGetExpectedSealDuration", params)
            .await
    }
    ...
    async fn sector_get_seal_delay(&self) -> Result<i64, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.SectorGetSealDelay", params)
            .await
    }
    ...
    async fn sector_mark_for_upgrade(&self, sector_number: u64, bool: bool) -> Result<(), Error> {
        ...
        self.client
            .request::<()>("Filecoin.SectorMarkForUpgrade", params)
            .await
    }
    ...
    async fn sector_match_pending_pieces_to_open_sectors(&self) -> Result<(), Error> {
        let params = vec![];
        self.client
            .request::<()>("Filecoin.SectorMatchPendingPiecesToOpenSectors", params)
            .await
    }
    ...
    async fn sector_num_assigner_meta(&self) -> Result<NumAssignerMeta, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.SectorNumAssignerMeta", params)
            .await
    }
    ...
    async fn sector_num_free(&self, string: String) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&string).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.SectorNumFree", params)
            .await
    }
    ...
    async fn sector_num_reservations(&self) -> Result<HashMap<String, BitField>, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.SectorNumReservations", params)
            .await
    }
    ...
    async fn sector_num_reserve(
        ...
        self.client
            .request::<()>("Filecoin.SectorNumReserve", params)
            .await
    }
    ...
    async fn sector_num_reserve_count(
        ...
        self.client
            .request("Filecoin.SectorNumReserveCount", params)
            .await
    }
    ...
    async fn sector_pre_commit_flush(&self) -> Result<Vec<PreCommitBatchRes>, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.SectorPreCommitFlush", params)
            .await
    }
    ...
    async fn sector_pre_commit_pending(&self) -> Result<Vec<SectorID>, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.SectorPreCommitPending", params)
            .await
    }

    async fn sector_receive(&self, remote_sector_meta: RemoteSectorMeta) -> Result<(), Error> {
        let params = vec![serde_json::to_value(&remote_sector_meta)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.SectorReceive", params)
            .await
    }
    ...
    async fn sector_remove(&self, sector_number: u64) -> Result<(), Error> {
        let params = vec![serde_json::to_value(&sector_number)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.SectorRemove", params)
            .await
    }

    async fn sector_set_expected_seal_duration(&self, duration: i64) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&duration)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.SectorSetExpectedSealDuration", params)
            .await
    }
    ...
    async fn sector_set_seal_delay(&self, duration: i64) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&duration)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.SectorSetSealDelay", params)
            .await
    }
    ...
    async fn sector_start_sealing(&self, sector_number: u64) -> Result<(), Error> {
        let params = vec![serde_json::to_value(&sector_number)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.SectorStartSealing", params)
            .await
    }
    ...
    async fn sector_terminate(&self, sector_number: u64) -> Result<(), Error> {
        let params = vec![serde_json::to_value(&sector_number)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.SectorTerminate", params)
            .await
    }
    ...
    async fn sector_terminate_flush(&self) -> Result<Option<Cid>, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.SectorTerminateFlush", params)
            .await
    }
    ...
    async fn sector_terminate_pending(&self) -> Result<Vec<SectorID>, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.SectorTerminatePending", params)
            .await
    }
    ...
    async fn sector_unseal(&self, sector_number: u64) -> Result<(), Error> {
        let params = vec![serde_json::to_value(&sector_number)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.SectorUnseal", params)
            .await
    }
    ...
    async fn sectors_list_in_states(&self, sector_states: Vec<String>) -> Result<Vec<u64>, Error> {
        let params = vec![serde_json::to_value(&sector_states)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.SectorsListInStates", params)
            .await
    }
    ...
    async fn sectors_unseal_piece(
        ...
        self.client
            .request::<()>("Filecoin.SectorsUnsealPiece", params)
            .await
    }
    ...
    async fn sectors_update(&self, sector_number: u64, sector_state: String) -> Result<(), Error> {
        let params = vec![
            serde_json::to_value(&sector_number)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&sector_state)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
        ];
        self.client
            .request::<()>("Filecoin.SectorsUpdate", params)
            .await
    }
    ...
    async fn storage_auth_verify(&self, string: String) -> Result<Vec<String>, Error> {
        let params =
            vec![serde_json::to_value(&string).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.StorageAuthVerify", params)
            .await
    }
    ...
    async fn storage_best_alloc(
        ...
        self.client
            .request("Filecoin.StorageBestAlloc", params)
            .await
    }
    ...
    async fn storage_declare_sector(
        ...
        self.client
            .request::<()>("Filecoin.StorageDeclareSector", params)
            .await
    }
    ...
    async fn storage_detach(&self, id: String, string: String) -> Result<(), Error> {
        ...
        self.client
            .request::<()>("Filecoin.StorageDetach", params)
            .await
    }
    ...
    async fn storage_drop_sector(
        ...
        self.client
            .request::<()>("Filecoin.StorageDropSector", params)
            .await
    }
    ...
    async fn storage_find_sector(
        ...
        self.client
            .request("Filecoin.StorageFindSector", params)
            .await
    }
    ...
    async fn storage_get_locks(&self) -> Result<SectorLocks, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.StorageGetLocks", params)
            .await
    }
    ...
    async fn storage_lock(
        ...
        let params = vec![
            ...
            serde_json::to_value(&sector_file_type)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&sector_file_type1)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
        ];
        self.client
            .request::<()>("Filecoin.StorageLock", params)
            .await
    }
    ...
    async fn storage_report_health(
        ...
        self.client
            .request::<()>("Filecoin.StorageReportHealth", params)
            .await
    }
    ...
    async fn worker_connect(&self, string: String) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&string).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.WorkerConnect", params)
            .await
    }
