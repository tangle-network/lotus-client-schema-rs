...
pub trait WorkerApi {
    async fn add_piece(&self, sector_ref: SectorRef, unpadded_piece_sizes: Vec<u64>, unpadded_piece_size: u64, reader: Value) -> Result<CallID, Error>;
    async fn data_cid(&self, unpadded_piece_size: u64, reader: Value) -> Result<CallID, Error>;
    async fn download_sector_data(&self, sector_ref: SectorRef, bool: bool, map: HashMap<i32, SectorLocation>) -> Result<CallID, Error>;
    async fn enabled(&self) -> Result<bool, Error>;
    async fn fetch(&self, sector_ref: SectorRef, sector_file_type: i32, path_type: String, acquire_mode: String) -> Result<CallID, Error>;
    ...
    async fn generate_sector_key_from_data(&self, sector_ref: SectorRef, cid: Cid) -> Result<CallID, Error>;
    async fn generate_window_po_st(&self, registered_po_st_proof: i64, actor_id: u64, post_sector_challenges: Vec<PostSectorChallenge>, int: i32, uint8s: Vec<u8>) -> Result<WindowPoStResult, Error>;
    async fn generate_winning_po_st(&self, registered_po_st_proof: i64, actor_id: u64, post_sector_challenges: Vec<PostSectorChallenge>, uint8s: Vec<u8>) -> Result<Vec<PoStProof>, Error>;
    async fn info(&self) -> Result<WorkerInfo, Error>;
    async fn move_storage(&self, sector_ref: SectorRef, sector_file_type: i32) -> Result<CallID, Error>;
    async fn paths(&self) -> Result<Vec<StoragePath>, Error>;
    async fn process_session(&self) -> Result<[u8; 16], Error>;
    async fn prove_replica_update1(&self, sector_ref: SectorRef, cid: Cid, cid1: Cid, cid2: Cid) -> Result<CallID, Error>;
    async fn prove_replica_update2(&self, sector_ref: SectorRef, cid: Cid, cid1: Cid, cid2: Cid, s: Vec<Vec<u8>>) -> Result<CallID, Error>;
    async fn release_unsealed(&self, sector_ref: SectorRef, ranges: Vec<Range>) -> Result<CallID, Error>;
    async fn remove(&self, sector_id: SectorID) -> Result<(), Error>;
    async fn replica_update(&self, sector_ref: SectorRef, piece_infos: Vec<PieceInfo>) -> Result<CallID, Error>;
    async fn seal_commit1(&self, sector_ref: SectorRef, uint8s: Vec<u8>, uint8s1: Vec<u8>, piece_infos: Vec<PieceInfo>, sector_cids: SectorCids) -> Result<CallID, Error>;
    async fn seal_commit2(&self, sector_ref: SectorRef, uint8s: Vec<u8>) -> Result<CallID, Error>;
    async fn seal_pre_commit1(&self, sector_ref: SectorRef, uint8s: Vec<u8>, piece_infos: Vec<PieceInfo>) -> Result<CallID, Error>;
    async fn seal_pre_commit2(&self, sector_ref: SectorRef, uint8s: Vec<u8>) -> Result<CallID, Error>;
    ...
    async fn unseal_piece(&self, sector_ref: SectorRef, unpadded_byte_index: u64, unpadded_piece_size: u64, uint8s: Vec<u8>, cid: Cid) -> Result<CallID, Error>;
...
impl WorkerApi for WorkerClient {
    async fn add_piece(&self, sector_ref: SectorRef, unpadded_piece_sizes: Vec<u64>, unpadded_piece_size: u64, reader: Value) -> Result<CallID, Error> {
        let params = vec![
            ...
            serde_json::to_value(&unpadded_piece_sizes).map_err(|e| Error::invalid_params(e.to_string()))?,
    ...
    async fn download_sector_data(&self, sector_ref: SectorRef, bool: bool, map: HashMap<i32, SectorLocation>) -> Result<CallID, Error> {
        ...
        self.client.request("Filecoin.DownloadSectorData", params).await
    }
    ...
    async fn fetch(&self, sector_ref: SectorRef, sector_file_type: i32, path_type: String, acquire_mode: String) -> Result<CallID, Error> {
        let params = vec![
            ...
            serde_json::to_value(&acquire_mode).map_err(|e| Error::invalid_params(e.to_string()))?,
        ];
    ...
    async fn finalize_replica_update(&self, sector_ref: SectorRef) -> Result<CallID, Error> {
        ...
        self.client.request("Filecoin.FinalizeReplicaUpdate", params).await
    }
    ...
    async fn generate_sector_key_from_data(&self, sector_ref: SectorRef, cid: Cid) -> Result<CallID, Error> {
        ...
        self.client.request("Filecoin.GenerateSectorKeyFromData", params).await
    }
    ...
    async fn generate_window_po_st(&self, registered_po_st_proof: i64, actor_id: u64, post_sector_challenges: Vec<PostSectorChallenge>, int: i32, uint8s: Vec<u8>) -> Result<WindowPoStResult, Error> {
        let params = vec![
            ...
            serde_json::to_value(&post_sector_challenges).map_err(|e| Error::invalid_params(e.to_string()))?,
        ...
        self.client.request("Filecoin.GenerateWindowPoSt", params).await
    }
    ...
    async fn generate_winning_po_st(&self, registered_po_st_proof: i64, actor_id: u64, post_sector_challenges: Vec<PostSectorChallenge>, uint8s: Vec<u8>) -> Result<Vec<PoStProof>, Error> {
        ...
        self.client.request("Filecoin.GenerateWinningPoSt", params).await
    }
    ...
    async fn prove_replica_update1(&self, sector_ref: SectorRef, cid: Cid, cid1: Cid, cid2: Cid) -> Result<CallID, Error> {
        ...
        self.client.request("Filecoin.ProveReplicaUpdate1", params).await
    }
    ...
    async fn prove_replica_update2(&self, sector_ref: SectorRef, cid: Cid, cid1: Cid, cid2: Cid, s: Vec<Vec<u8>>) -> Result<CallID, Error> {
        ...
        self.client.request("Filecoin.ProveReplicaUpdate2", params).await
    }
    ...
    async fn release_unsealed(&self, sector_ref: SectorRef, ranges: Vec<Range>) -> Result<CallID, Error> {
        ...
        self.client.request("Filecoin.ReleaseUnsealed", params).await
    }
    ...
    async fn set_enabled(&self, bool: bool) -> Result<(), Error> {
        ...
        self.client.request::<()>("Filecoin.SetEnabled", params).await
    }
    ...
    async fn storage_detach_all(&self) -> Result<(), Error> {
        let params = vec![];
        self.client.request::<()>("Filecoin.StorageDetachAll", params).await
    }
    ...
    async fn task_disable(&self, task_type: String) -> Result<(), Error> {
        let params = vec![
            serde_json::to_value(&task_type).map_err(|e| Error::invalid_params(e.to_string()))?,
        ];
        self.client.request::<()>("Filecoin.TaskDisable", params).await
    }
    ...
    async fn task_enable(&self, task_type: String) -> Result<(), Error> {
        ...
        self.client.request::<()>("Filecoin.TaskEnable", params).await
    }
    ...
    async fn wait_quiet(&self) -> Result<(), Error> {
        let params = vec![];
        self.client.request::<()>("Filecoin.WaitQuiet", params).await
    }
