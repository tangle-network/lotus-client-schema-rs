...
pub trait FullNodeApi {
    ...
    async fn f3_get_ec_power_table(
        &self,
        tip_set_key: Option<TipSetKey>,
    ) -> Result<Vec<PowerEntry>, Error>;
    async fn f3_get_f3_power_table(
        &self,
        tip_set_key: Option<TipSetKey>,
    ) -> Result<Vec<PowerEntry>, Error>;
    ...
    async fn state_circulating_supply(
        &self,
        tip_set_key: Option<TipSetKey>,
    ) -> Result<String, Error>;
    ...
    async fn state_list_actors(&self, tip_set_key: Option<TipSetKey>)
    ...
    async fn state_list_miners(&self, tip_set_key: Option<TipSetKey>)
        -> Result<Vec<String>, Error>;
