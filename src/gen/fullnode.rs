...
pub struct ActorEventFilter {
    ...
    pub tip_set_key: Option<Vec<Cid>>,
}
...
pub trait FullNodeApi {
    ...
    async fn chain_export_range_internal(
        &self,
        tip_set_key: Vec<Cid>,
        tip_set_key1: Vec<Cid>,
    ...
    async fn chain_get_parent_receipts(
        &self,
        cid: Cid,
    ) -> Result<Vec<Option<MessageReceipt>>, Error>;
    async fn chain_get_path(
        &self,
        tip_set_key: Vec<Cid>,
        tip_set_key1: Vec<Cid>,
    ) -> Result<Vec<Option<HeadChange>>, Error>;
    async fn chain_get_tip_set(&self, tip_set_key: Vec<Cid>) -> Result<Option<TipSet>, Error>;
    ...
    async fn chain_set_head(&self, tip_set_key: Vec<Cid>) -> Result<(), Error>;
    async fn chain_stat_obj(&self, cid: Cid, cid1: Cid) -> Result<ObjStat, Error>;
    async fn chain_tip_set_weight(&self, tip_set_key: Vec<Cid>) -> Result<String, Error>;
    ...
    async fn eth_address_to_filecoin_address(&self, eth_address: [u8; 20])
        -> Result<String, Error>;
    ...
    async fn eth_get_filter_changes(
        &self,
        eth_filter_id: [u8; 32],
    ) -> Result<Option<EthFilterResult>, Error>;
    ...
    async fn eth_get_message_cid_by_transaction_hash(
        &self,
    ...
    async fn eth_get_transaction_by_hash(
        &self,
        eth_hash: Option<[u8; 32]>,
    ) -> Result<Option<EthTx>, Error>;
    async fn eth_get_transaction_by_hash_limited(
        &self,
        eth_hash: Option<[u8; 32]>,
        chain_epoch: i64,
    ) -> Result<Option<EthTx>, Error>;
    ...
    async fn eth_get_transaction_receipt(
        &self,
        eth_hash: [u8; 32],
    ) -> Result<Option<EthTxReceipt>, Error>;
    async fn eth_get_transaction_receipt_limited(
        &self,
        eth_hash: [u8; 32],
        chain_epoch: i64,
    ) -> Result<Option<EthTxReceipt>, Error>;
    ...
    async fn eth_trace_filter(
        &self,
        eth_trace_filter_criteria: EthTraceFilterCriteria,
    ) -> Result<Vec<Option<EthTraceFilterResult>>, Error>;
    async fn eth_trace_replay_block_transactions(
        &self,
        string: String,
        strings: Vec<String>,
    ) -> Result<Vec<Option<EthTraceReplayBlockTransaction>>, Error>;
    async fn eth_trace_transaction(
        &self,
        string: String,
    ) -> Result<Vec<Option<EthTraceTransaction>>, Error>;
    ...
    async fn f3_get_ec_power_table(&self, tip_set_key: Vec<Cid>) -> Result<Vec<PowerEntry>, Error>;
    async fn f3_get_f3_power_table(&self, tip_set_key: Vec<Cid>) -> Result<Vec<PowerEntry>, Error>;
    ...
    async fn f3_get_or_renew_participation_ticket(
        &self,
        address: String,
        uint8s: Vec<u8>,
        uint64: u64,
    ...
    async fn get_actor_events_raw(
        &self,
        actor_event_filter: Option<ActorEventFilter>,
    ) -> Result<Vec<Option<ActorEvent>>, Error>;
    ...
    async fn mpool_batch_push_message(
        &self,
        s: Vec<Option<Message>>,
        message_send_spec: Option<MessageSendSpec>,
    ) -> Result<Vec<Option<SignedMessage>>, Error>;
    async fn mpool_batch_push_untrusted(
        &self,
        s: Vec<Option<SignedMessage>>,
    ) -> Result<Vec<Cid>, Error>;
    async fn mpool_check_messages(
        &self,
        s: Vec<Option<MessagePrototype>>,
    ) -> Result<Vec<Vec<MessageCheckStatus>>, Error>;
    async fn mpool_check_pending_messages(
        &self,
        address: String,
    ) -> Result<Vec<Vec<MessageCheckStatus>>, Error>;
    async fn mpool_check_replace_messages(
        &self,
        s: Vec<Option<Message>>,
    ) -> Result<Vec<Vec<MessageCheckStatus>>, Error>;
    ...
    async fn msig_add_approve(
        ...
        address3: String,
        bool: bool,
    ) -> Result<Option<MessagePrototype>, Error>;
    async fn msig_add_cancel(
        &self,
        address: String,
        address1: String,
        uint64: u64,
    ...
    async fn msig_approve_txn_hash(
        &self,
        address: String,
        uint64: u64,
        address1: String,
    ...
    async fn msig_get_pending(
        ...
        address: String,
        tip_set_key: Vec<Cid>,
    ) -> Result<Vec<Option<MsigTransaction>>, Error>;
    ...
    async fn msig_get_vesting_schedule(
        &self,
        address: String,
        tip_set_key: Vec<Cid>,
    ) -> Result<MsigVesting, Error>;
    ...
    async fn paych_available_funds(
        &self,
        address: String,
    ) -> Result<Option<ChannelAvailableFunds>, Error>;
    async fn paych_available_funds_by_from_to(
        &self,
        address: String,
        address1: String,
    ) -> Result<Option<ChannelAvailableFunds>, Error>;
    ...
    async fn paych_voucher_create(
        ...
        int: String,
        uint64: u64,
    ) -> Result<Option<VoucherCreateResult>, Error>;
    async fn paych_voucher_list(
        &self,
        address: String,
    ) -> Result<Vec<Option<SignedVoucher>>, Error>;
    ...
    async fn state_all_miner_faults(
        ...
        chain_epoch: i64,
        tip_set_key: Vec<Cid>,
    ) -> Result<Vec<Option<Fault>>, Error>;
    async fn state_call(
        &self,
        message: Option<Message>,
        tip_set_key: Vec<Cid>,
    ) -> Result<Option<InvocResult>, Error>;
    async fn state_changed_actors(
        &self,
        cid: Cid,
        cid1: Cid,
    ) -> Result<HashMap<String, ActorV5>, Error>;
    async fn state_circulating_supply(&self, tip_set_key: Vec<Cid>) -> Result<String, Error>;
    async fn state_compute(
        &self,
        chain_epoch: i64,
        s: Vec<Option<Message>>,
        tip_set_key: Vec<Cid>,
    ) -> Result<Option<ComputeStateOutput>, Error>;
    async fn state_compute_data_cid(
        &self,
        address: String,
    ...
    async fn state_deal_provider_collateral_bounds(
        ...
        bool: bool,
        tip_set_key: Vec<Cid>,
    ) -> Result<DealCollateralBounds, Error>;
    async fn state_decode_params(
        &self,
        address: String,
        method_num: u64,
        uint8s: Vec<u8>,
    ...
    async fn state_get_actor(
        ...
        address: String,
        tip_set_key: Vec<Cid>,
    ) -> Result<Option<ActorV5>, Error>;
    async fn state_get_all_allocations(
        &self,
        tip_set_key: Vec<Cid>,
    ) -> Result<HashMap<u64, Allocation>, Error>;
    async fn state_get_all_claims(
        &self,
        tip_set_key: Vec<Cid>,
    ) -> Result<HashMap<u64, Claim>, Error>;
    async fn state_get_allocation(
        &self,
        address: String,
        allocation_id: u64,
        tip_set_key: Vec<Cid>,
    ) -> Result<Option<Allocation>, Error>;
    async fn state_get_allocation_for_pending_deal(
        &self,
        deal_id: u64,
        tip_set_key: Vec<Cid>,
    ) -> Result<Option<Allocation>, Error>;
    async fn state_get_allocation_id_for_pending_deal(
        &self,
        deal_id: u64,
        tip_set_key: Vec<Cid>,
    ) -> Result<u64, Error>;
    async fn state_get_allocations(
        &self,
        address: String,
        tip_set_key: Vec<Cid>,
    ) -> Result<HashMap<u64, Allocation>, Error>;
    async fn state_get_beacon_entry(&self, chain_epoch: i64) -> Result<Option<BeaconEntry>, Error>;
    async fn state_get_claim(
        &self,
        address: String,
        claim_id: u64,
        tip_set_key: Vec<Cid>,
    ) -> Result<Option<Claim>, Error>;
    async fn state_get_claims(
        &self,
        address: String,
        tip_set_key: Vec<Cid>,
    ) -> Result<HashMap<u64, Claim>, Error>;
    async fn state_get_network_params(&self) -> Result<Option<NetworkParams>, Error>;
    async fn state_get_randomness_digest_from_beacon(
        &self,
        chain_epoch: i64,
        tip_set_key: Vec<Cid>,
    ) -> Result<String, Error>;
    async fn state_get_randomness_digest_from_tickets(
        &self,
        chain_epoch: i64,
        tip_set_key: Vec<Cid>,
    ) -> Result<String, Error>;
    ...
    async fn state_list_actors(&self, tip_set_key: Vec<Cid>) -> Result<Vec<String>, Error>;
    ...
    async fn state_list_miners(&self, tip_set_key: Vec<Cid>) -> Result<Vec<String>, Error>;
    ...
    async fn state_market_deals(
        &self,
        tip_set_key: Vec<Cid>,
    ) -> Result<HashMap<String, Option<MarketDeal>>, Error>;
    async fn state_market_participants(
        &self,
        tip_set_key: Vec<Cid>,
    ) -> Result<HashMap<String, MarketBalance>, Error>;
    async fn state_market_storage_deal(
        &self,
        deal_id: u64,
        tip_set_key: Vec<Cid>,
    ) -> Result<Option<MarketDeal>, Error>;
    async fn state_miner_active_sectors(
        &self,
        address: String,
        tip_set_key: Vec<Cid>,
    ) -> Result<Vec<Option<SectorOnChainInfo>>, Error>;
    async fn state_miner_allocated(
        &self,
        address: String,
        tip_set_key: Vec<Cid>,
    ) -> Result<Option<BitField>, Error>;
    ...
    async fn state_miner_initial_pledge_for_sector(
        &self,
        chain_epoch: i64,
        sector_size: u64,
        uint64: u64,
    ...
    async fn state_miner_power(
        ...
        address: String,
        tip_set_key: Vec<Cid>,
    ) -> Result<Option<MinerPower>, Error>;
    async fn state_miner_pre_commit_deposit_for_power(
        &self,
        address: String,
        sector_pre_commit_info: SectorPreCommitInfo,
        tip_set_key: Vec<Cid>,
    ...
    async fn state_miner_recoveries(
        &self,
        address: String,
        tip_set_key: Vec<Cid>,
    ) -> Result<BitField, Error>;
    async fn state_miner_sector_allocated(
        &self,
        address: String,
        sector_number: u64,
        tip_set_key: Vec<Cid>,
    ...
    async fn state_network_version(&self, tip_set_key: Vec<Cid>) -> Result<u32, Error>;
    ...
    async fn state_search_msg(
        ...
        chain_epoch: i64,
        bool: bool,
    ) -> Result<Option<MsgLookup>, Error>;
    async fn state_sector_expiration(
        &self,
        address: String,
        sector_number: u64,
        tip_set_key: Vec<Cid>,
    ) -> Result<Option<SectorExpiration>, Error>;
    ...
    async fn state_sector_partition(
        ...
        sector_number: u64,
        tip_set_key: Vec<Cid>,
    ) -> Result<Option<SectorLocation>, Error>;
    ...
    async fn state_vm_circulating_supply_internal(
        &self,
        tip_set_key: Vec<Cid>,
    ...
    async fn state_verified_registry_root_key(
        &self,
        tip_set_key: Vec<Cid>,
    ) -> Result<String, Error>;
    async fn state_verifier_status(
        &self,
        address: String,
        tip_set_key: Vec<Cid>,
    ) -> Result<Option<String>, Error>;
    ...
    async fn subscribe_actor_events_raw(
        &self,
        actor_event_filter: Option<ActorEventFilter>,
    ) -> Result<mpsc::Receiver<Option<ActorEvent>>, Error>;
    async fn sync_check_bad(&self, cid: Cid) -> Result<String, Error>;
    async fn sync_checkpoint(&self, tip_set_key: Vec<Cid>) -> Result<(), Error>;
    ...
    async fn sync_validate_tipset(&self, tip_set_key: Vec<Cid>) -> Result<bool, Error>;
...
impl FullNodeApi for FullNodeClient {
    async fn auth_new(&self, permissions: Vec<String>) -> Result<Vec<u8>, Error> {
        let params =
            vec![serde_json::to_value(&permissions)
    ...
    async fn chain_blockstore_info(&self) -> Result<HashMap<String, Value>, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.ChainBlockstoreInfo", params)
            .await
    }
    ...
    async fn chain_check_blockstore(&self) -> Result<(), Error> {
        let params = vec![];
        self.client
            .request::<()>("Filecoin.ChainCheckBlockstore", params)
            .await
    }

    async fn chain_delete_obj(&self, cid: Cid) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&cid).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.ChainDeleteObj", params)
            .await
    }
    ...
    async fn chain_export_range_internal(
        ...
        let params = vec![
            serde_json::to_value(&tip_set_key).map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&tip_set_key1)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&chain_export_config)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
        ];
        self.client
            .request::<()>("Filecoin.ChainExportRangeInternal", params)
            .await
    }
    ...
    async fn chain_get_block_messages(&self, cid: Cid) -> Result<Option<BlockMessages>, Error> {
        let params =
            vec![serde_json::to_value(&cid).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.ChainGetBlockMessages", params)
            .await
    }
    ...
    async fn chain_get_genesis(&self) -> Result<Option<TipSet>, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.ChainGetGenesis", params)
            .await
    }
    ...
    async fn chain_get_message(&self, cid: Cid) -> Result<Option<Message>, Error> {
        let params =
            vec![serde_json::to_value(&cid).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.ChainGetMessage", params)
            .await
    }
    ...
    async fn chain_get_messages_in_tipset(
        ...
        let params =
            vec![serde_json::to_value(&tip_set_key)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.ChainGetMessagesInTipset", params)
            .await
    }
    ...
    async fn chain_get_parent_messages(&self, cid: Cid) -> Result<Vec<Message>, Error> {
        let params =
            vec![serde_json::to_value(&cid).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.ChainGetParentMessages", params)
            .await
    }
    ...
    async fn chain_get_parent_receipts(
        ...
        let params =
            vec![serde_json::to_value(&cid).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.ChainGetParentReceipts", params)
            .await
    }
    ...
    async fn chain_get_tip_set_after_height(
        ...
        self.client
            .request("Filecoin.ChainGetTipSetAfterHeight", params)
            .await
    }
    ...
    async fn chain_get_tip_set_by_height(
        ...
        self.client
            .request("Filecoin.ChainGetTipSetByHeight", params)
            .await
    }
    ...
    async fn chain_hot_gc(&self, hot_gc_opts: HotGCOpts) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&hot_gc_opts)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.ChainHotGC", params)
            .await
    }
    ...
    async fn chain_prune(&self, prune_opts: PruneOpts) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&prune_opts)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.ChainPrune", params)
            .await
    }

    async fn chain_put_obj(&self, block: Value) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&block).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.ChainPutObj", params)
            .await
    }
    ...
    async fn chain_set_head(&self, tip_set_key: Vec<Cid>) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&tip_set_key)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.ChainSetHead", params)
            .await
    }
    ...
    async fn create_backup(&self, string: String) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&string).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.CreateBackup", params)
            .await
    }
    ...
    async fn eth_address_to_filecoin_address(
        &self,
        eth_address: [u8; 20],
    ) -> Result<String, Error> {
        let params =
            vec![serde_json::to_value(&eth_address)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.EthAddressToFilecoinAddress", params)
            .await
    }
    ...
    async fn eth_call(
        ...
        let params = vec![
            ...
            serde_json::to_value(&eth_block_number_or_hash)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
        ];
    ...
    async fn eth_estimate_gas(&self, uint8s: Vec<u8>) -> Result<u64, Error> {
        let params =
            vec![serde_json::to_value(&uint8s).map_err(|e| Error::invalid_params(e.to_string()))?];
    ...
    async fn eth_get_block_by_hash(
        ...
        self.client
            .request("Filecoin.EthGetBlockByHash", params)
            .await
    }
    ...
    async fn eth_get_block_by_number(&self, string: String, bool: bool) -> Result<EthBlock, Error> {
        ...
        self.client
            .request("Filecoin.EthGetBlockByNumber", params)
            .await
    }
    ...
    async fn eth_get_block_receipts(
        ...
        let params = vec![serde_json::to_value(&eth_block_number_or_hash)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.EthGetBlockReceipts", params)
            .await
    }
    ...
    async fn eth_get_block_receipts_limited(
        ...
        self.client
            .request("Filecoin.EthGetBlockReceiptsLimited", params)
            .await
    }
    ...
    async fn eth_get_block_transaction_count_by_hash(
        ...
        let params =
            vec![serde_json::to_value(&eth_hash)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.EthGetBlockTransactionCountByHash", params)
            .await
    }
    ...
    async fn eth_get_block_transaction_count_by_number(
        ...
        let params =
            vec![serde_json::to_value(&eth_uint64)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.EthGetBlockTransactionCountByNumber", params)
            .await
    }
    ...
    async fn eth_get_filter_changes(
        ...
        let params = vec![serde_json::to_value(&eth_filter_id)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.EthGetFilterChanges", params)
            .await
    }
    ...
    async fn eth_get_filter_logs(
        ...
        let params = vec![serde_json::to_value(&eth_filter_id)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.EthGetFilterLogs", params)
            .await
    }
    ...
    async fn eth_get_logs(
        ...
        let params = vec![serde_json::to_value(&eth_filter_spec)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
    ...
    async fn eth_get_message_cid_by_transaction_hash(
        ...
        let params =
            vec![serde_json::to_value(&eth_hash)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.EthGetMessageCidByTransactionHash", params)
            .await
    }
    ...
    async fn eth_get_storage_at(
        ...
        self.client
            .request("Filecoin.EthGetStorageAt", params)
            .await
    }
    ...
    async fn eth_get_transaction_by_block_hash_and_index(
        ...
        self.client
            .request("Filecoin.EthGetTransactionByBlockHashAndIndex", params)
            .await
    }
    ...
    async fn eth_get_transaction_by_block_number_and_index(
        ...
        self.client
            .request("Filecoin.EthGetTransactionByBlockNumberAndIndex", params)
            .await
    }
    ...
    async fn eth_get_transaction_by_hash(
        ...
        let params =
            vec![serde_json::to_value(&eth_hash)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.EthGetTransactionByHash", params)
            .await
    }
    ...
    async fn eth_get_transaction_by_hash_limited(
        ...
        self.client
            .request("Filecoin.EthGetTransactionByHashLimited", params)
            .await
    }
    ...
    async fn eth_get_transaction_count(
        ...
        self.client
            .request("Filecoin.EthGetTransactionCount", params)
            .await
    }
    ...
    async fn eth_get_transaction_hash_by_cid(&self, cid: Cid) -> Result<Option<[u8; 32]>, Error> {
        let params =
            vec![serde_json::to_value(&cid).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.EthGetTransactionHashByCid", params)
            .await
    }
    ...
    async fn eth_get_transaction_receipt(
        ...
        let params =
            vec![serde_json::to_value(&eth_hash)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.EthGetTransactionReceipt", params)
            .await
    }
    ...
    async fn eth_get_transaction_receipt_limited(
        ...
        self.client
            .request("Filecoin.EthGetTransactionReceiptLimited", params)
            .await
    }
    ...
    async fn eth_max_priority_fee_per_gas(&self) -> Result<EthBigInt, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.EthMaxPriorityFeePerGas", params)
            .await
    }
    ...
    async fn eth_new_block_filter(&self) -> Result<[u8; 32], Error> {
        let params = vec![];
        self.client
            .request("Filecoin.EthNewBlockFilter", params)
            .await
    }
    ...
    async fn eth_new_pending_transaction_filter(&self) -> Result<[u8; 32], Error> {
        let params = vec![];
        self.client
            .request("Filecoin.EthNewPendingTransactionFilter", params)
            .await
    }
    ...
    async fn eth_protocol_version(&self) -> Result<u64, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.EthProtocolVersion", params)
            .await
    }
    ...
    async fn eth_send_raw_transaction(&self, uint8s: Vec<u8>) -> Result<[u8; 32], Error> {
        let params =
            vec![serde_json::to_value(&uint8s).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.EthSendRawTransaction", params)
            .await
    }
    ...
    async fn eth_send_raw_transaction_untrusted(&self, uint8s: Vec<u8>) -> Result<[u8; 32], Error> {
        let params =
            vec![serde_json::to_value(&uint8s).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.EthSendRawTransactionUntrusted", params)
            .await
    }
    ...
    async fn eth_trace_filter(
        ...
        let params = vec![serde_json::to_value(&eth_trace_filter_criteria)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
    ...
    async fn eth_trace_replay_block_transactions(
        ...
        self.client
            .request("Filecoin.EthTraceReplayBlockTransactions", params)
            .await
    }
    ...
    async fn eth_trace_transaction(
        ...
        let params =
            vec![serde_json::to_value(&string).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.EthTraceTransaction", params)
            .await
    }
    ...
    async fn eth_uninstall_filter(&self, eth_filter_id: [u8; 32]) -> Result<bool, Error> {
        let params = vec![serde_json::to_value(&eth_filter_id)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.EthUninstallFilter", params)
            .await
    }

    async fn eth_unsubscribe(&self, eth_subscription_id: [u8; 32]) -> Result<bool, Error> {
        let params = vec![serde_json::to_value(&eth_subscription_id)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
    ...
    async fn f3_get_certificate(&self, uint64: u64) -> Result<Option<FinalityCertificate>, Error> {
        let params =
            vec![serde_json::to_value(&uint64).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
    ...
    async fn f3_get_ec_power_table(&self, tip_set_key: Vec<Cid>) -> Result<Vec<PowerEntry>, Error> {
        let params =
            vec![serde_json::to_value(&tip_set_key)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.F3GetECPowerTable", params)
            .await
    }
    ...
    async fn f3_get_f3_power_table(&self, tip_set_key: Vec<Cid>) -> Result<Vec<PowerEntry>, Error> {
        let params =
            vec![serde_json::to_value(&tip_set_key)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.F3GetF3PowerTable", params)
            .await
    }
    ...
    async fn f3_get_latest_certificate(&self) -> Result<Option<FinalityCertificate>, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.F3GetLatestCertificate", params)
            .await
    }
    ...
    async fn f3_get_or_renew_participation_ticket(
        ...
        self.client
            .request("Filecoin.F3GetOrRenewParticipationTicket", params)
            .await
    }
    ...
    async fn f3_list_participants(&self) -> Result<Vec<F3Participant>, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.F3ListParticipants", params)
            .await
    }
    ...
    async fn filecoin_address_to_eth_address(&self, uint8s: Vec<u8>) -> Result<[u8; 20], Error> {
        let params =
            vec![serde_json::to_value(&uint8s).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.FilecoinAddressToEthAddress", params)
            .await
    }
    ...
    async fn gas_estimate_fee_cap(
        ...
        self.client
            .request("Filecoin.GasEstimateFeeCap", params)
            .await
    }
    ...
    async fn gas_estimate_gas_limit(
        ...
        self.client
            .request("Filecoin.GasEstimateGasLimit", params)
            .await
    }
    ...
    async fn gas_estimate_gas_premium(
        ...
        self.client
            .request("Filecoin.GasEstimateGasPremium", params)
            .await
    }
    ...
    async fn gas_estimate_message_gas(
        ...
        let params = vec![
            serde_json::to_value(&message).map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&message_send_spec)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&tip_set_key).map_err(|e| Error::invalid_params(e.to_string()))?,
        ];
        self.client
            .request("Filecoin.GasEstimateMessageGas", params)
            .await
    }
    ...
    async fn get_actor_events_raw(
        ...
        let params = vec![serde_json::to_value(&actor_event_filter)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.GetActorEventsRaw", params)
            .await
    }
    ...
    async fn log_set_level(&self, string: String, string1: String) -> Result<(), Error> {
        ...
        self.client
            .request::<()>("Filecoin.LogSetLevel", params)
            .await
    }
    ...
    async fn market_add_balance(
        ...
        self.client
            .request("Filecoin.MarketAddBalance", params)
            .await
    }
    ...
    async fn market_get_reserved(&self, address: String) -> Result<String, Error> {
        ...
        self.client
            .request("Filecoin.MarketGetReserved", params)
            .await
    }
    ...
    async fn market_release_funds(&self, address: String, int: String) -> Result<(), Error> {
        ...
        self.client
            .request::<()>("Filecoin.MarketReleaseFunds", params)
            .await
    }
    ...
    async fn market_reserve_funds(
        ...
        self.client
            .request("Filecoin.MarketReserveFunds", params)
            .await
    }
    ...
    async fn miner_create_block(
        ...
        let params = vec![serde_json::to_value(&block_template)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.MinerCreateBlock", params)
            .await
    }
    ...
    async fn miner_get_base_info(
        ...
        self.client
            .request("Filecoin.MinerGetBaseInfo", params)
            .await
    }

    async fn mpool_batch_push(&self, s: Vec<Option<SignedMessage>>) -> Result<Vec<Cid>, Error> {
        let params =
            vec![serde_json::to_value(&s).map_err(|e| Error::invalid_params(e.to_string()))?];
    ...
    async fn mpool_batch_push_message(
        ...
        self.client
            .request("Filecoin.MpoolBatchPushMessage", params)
            .await
    }
    ...
    async fn mpool_batch_push_untrusted(
        ...
        let params =
            vec![serde_json::to_value(&s).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.MpoolBatchPushUntrusted", params)
            .await
    }
    ...
    async fn mpool_check_messages(
        ...
        let params =
            vec![serde_json::to_value(&s).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.MpoolCheckMessages", params)
            .await
    }
    ...
    async fn mpool_check_pending_messages(
        ...
        let params =
            vec![serde_json::to_value(&address).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.MpoolCheckPendingMessages", params)
            .await
    }
    ...
    async fn mpool_check_replace_messages(
        ...
        let params =
            vec![serde_json::to_value(&s).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.MpoolCheckReplaceMessages", params)
            .await
    }
    ...
    async fn mpool_clear(&self, bool: bool) -> Result<(), Error> {
        ...
        self.client
            .request::<()>("Filecoin.MpoolClear", params)
            .await
    }
    ...
    async fn mpool_push(&self, signed_message: Option<SignedMessage>) -> Result<Cid, Error> {
        let params = vec![serde_json::to_value(&signed_message)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
    ...
    async fn mpool_push_message(
        ...
        self.client
            .request("Filecoin.MpoolPushMessage", params)
            .await
    }
    ...
    async fn mpool_push_untrusted(
        ...
        let params = vec![serde_json::to_value(&signed_message)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.MpoolPushUntrusted", params)
            .await
    }
    ...
    async fn mpool_set_config(&self, mpool_config: Option<MpoolConfig>) -> Result<(), Error> {
        let params = vec![serde_json::to_value(&mpool_config)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.MpoolSetConfig", params)
            .await
    }
    ...
    async fn msig_approve_txn_hash(
        ...
        self.client
            .request("Filecoin.MsigApproveTxnHash", params)
            .await
    }
    ...
    async fn msig_cancel_txn_hash(
        ...
        self.client
            .request("Filecoin.MsigCancelTxnHash", params)
            .await
    }
    ...
    async fn msig_get_available_balance(
        ...
        self.client
            .request("Filecoin.MsigGetAvailableBalance", params)
            .await
    }
    ...
    async fn msig_get_vesting_schedule(
        ...
        self.client
            .request("Filecoin.MsigGetVestingSchedule", params)
            .await
    }
    ...
    async fn msig_remove_signer(
        ...
        self.client
            .request("Filecoin.MsigRemoveSigner", params)
            .await
    }
    ...
    async fn msig_swap_approve(
        ...
        self.client
            .request("Filecoin.MsigSwapApprove", params)
            .await
    }
    ...
    async fn msig_swap_propose(
        ...
        self.client
            .request("Filecoin.MsigSwapPropose", params)
            .await
    }
    ...
    async fn net_agent_version(&self, id: String) -> Result<String, Error> {
        let params =
            vec![serde_json::to_value(&id).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.NetAgentVersion", params)
            .await
    }
    ...
    async fn net_auto_nat_status(&self) -> Result<NatInfo, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.NetAutoNatStatus", params)
            .await
    }
    ...
    async fn net_bandwidth_stats(&self) -> Result<Stats, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.NetBandwidthStats", params)
            .await
    }
    ...
    async fn net_bandwidth_stats_by_peer(&self) -> Result<HashMap<String, Stats>, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.NetBandwidthStatsByPeer", params)
            .await
    }
    ...
    async fn net_bandwidth_stats_by_protocol(&self) -> Result<HashMap<String, Stats>, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.NetBandwidthStatsByProtocol", params)
            .await
    }

    async fn net_block_add(&self, net_block_list: NetBlockList) -> Result<(), Error> {
        let params = vec![serde_json::to_value(&net_block_list)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.NetBlockAdd", params)
            .await
    }
    ...
    async fn net_block_remove(&self, net_block_list: NetBlockList) -> Result<(), Error> {
        let params = vec![serde_json::to_value(&net_block_list)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.NetBlockRemove", params)
            .await
    }

    async fn net_connect(&self, addr_info: AddrInfo) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&addr_info)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.NetConnect", params)
            .await
    }
    ...
    async fn net_connectedness(&self, id: String) -> Result<i32, Error> {
        let params =
            vec![serde_json::to_value(&id).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.NetConnectedness", params)
            .await
    }
    ...
    async fn net_disconnect(&self, id: String) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&id).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.NetDisconnect", params)
            .await
    }
    ...
    async fn net_protect_add(&self, ids: Vec<String>) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&ids).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.NetProtectAdd", params)
            .await
    }
    ...
    async fn net_protect_remove(&self, ids: Vec<String>) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&ids).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.NetProtectRemove", params)
            .await
    }
    ...
    async fn net_pubsub_scores(&self) -> Result<Vec<PubsubScore>, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.NetPubsubScores", params)
            .await
    }
    ...
    async fn net_set_limit(&self, string: String, net_limit: NetLimit) -> Result<(), Error> {
        ...
        self.client
            .request::<()>("Filecoin.NetSetLimit", params)
            .await
    }
    ...
    async fn paych_allocate_lane(&self, address: String) -> Result<u64, Error> {
        let params =
            vec![serde_json::to_value(&address).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.PaychAllocateLane", params)
            .await
    }
    ...
    async fn paych_available_funds(
        ...
        let params =
            vec![serde_json::to_value(&address).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.PaychAvailableFunds", params)
            .await
    }
    ...
    async fn paych_available_funds_by_from_to(
        ...
        self.client
            .request("Filecoin.PaychAvailableFundsByFromTo", params)
            .await
    }
    ...
    async fn paych_get(
        ...
        let params = vec![
            ...
            serde_json::to_value(&address1).map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&int).map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&paych_get_opts)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
        ];
    ...
    async fn paych_get_wait_ready(&self, cid: Cid) -> Result<String, Error> {
        let params =
            vec![serde_json::to_value(&cid).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.PaychGetWaitReady", params)
            .await
    }
    ...
    async fn paych_new_payment(
        ...
        let params = vec![
            serde_json::to_value(&address).map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&address1).map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&voucher_specs)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
        ];
        self.client
            .request("Filecoin.PaychNewPayment", params)
            .await
    }
    ...
    async fn paych_voucher_add(
        ...
        let params = vec![
            serde_json::to_value(&address).map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&signed_voucher)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&uint8s).map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&int).map_err(|e| Error::invalid_params(e.to_string()))?,
        ];
        self.client
            .request("Filecoin.PaychVoucherAdd", params)
            .await
    }
    ...
    async fn paych_voucher_check_spendable(
        ...
        self.client
            .request("Filecoin.PaychVoucherCheckSpendable", params)
            .await
    }
    ...
    async fn paych_voucher_check_valid(
        ...
        self.client
            .request::<()>("Filecoin.PaychVoucherCheckValid", params)
            .await
    }
    ...
    async fn paych_voucher_create(
        ...
        self.client
            .request("Filecoin.PaychVoucherCreate", params)
            .await
    }
    ...
    async fn paych_voucher_list(
        ...
        let params =
            vec![serde_json::to_value(&address).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.PaychVoucherList", params)
            .await
    }
    ...
    async fn paych_voucher_submit(
        ...
        self.client
            .request("Filecoin.PaychVoucherSubmit", params)
            .await
    }
    ...
    async fn state_account_key(
        ...
        self.client
            .request("Filecoin.StateAccountKey", params)
            .await
    }

    async fn state_actor_code_ci_ds(&self, version: u32) -> Result<HashMap<String, Cid>, Error> {
        let params =
            vec![serde_json::to_value(&version).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.StateActorCodeCIDs", params)
            .await
    }
    ...
    async fn state_actor_manifest_cid(&self, version: u32) -> Result<Cid, Error> {
        let params =
            vec![serde_json::to_value(&version).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.StateActorManifestCID", params)
            .await
    }
    ...
    async fn state_all_miner_faults(
        ...
        self.client
            .request("Filecoin.StateAllMinerFaults", params)
            .await
    }
    ...
    async fn state_changed_actors(
        ...
        self.client
            .request("Filecoin.StateChangedActors", params)
            .await
    }
    ...
    async fn state_circulating_supply(&self, tip_set_key: Vec<Cid>) -> Result<String, Error> {
        let params =
            vec![serde_json::to_value(&tip_set_key)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.StateCirculatingSupply", params)
            .await
    }
    ...
    async fn state_compute_data_cid(
        ...
        let params = vec![
            serde_json::to_value(&address).map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&registered_seal_proof)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&deal_ids).map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&tip_set_key).map_err(|e| Error::invalid_params(e.to_string()))?,
        ];
        self.client
            .request("Filecoin.StateComputeDataCID", params)
            .await
    }
    ...
    async fn state_deal_provider_collateral_bounds(
        ...
        let params = vec![
            serde_json::to_value(&padded_piece_size)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&bool).map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&tip_set_key).map_err(|e| Error::invalid_params(e.to_string()))?,
        ];
        self.client
            .request("Filecoin.StateDealProviderCollateralBounds", params)
            .await
    }
    ...
    async fn state_decode_params(
        ...
        self.client
            .request("Filecoin.StateDecodeParams", params)
            .await
    }
    ...
    async fn state_encode_params(
        ...
        self.client
            .request("Filecoin.StateEncodeParams", params)
            .await
    }
    ...
    async fn state_get_all_allocations(
        ...
        let params =
            vec![serde_json::to_value(&tip_set_key)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.StateGetAllAllocations", params)
            .await
    }
    ...
    async fn state_get_all_claims(
        ...
        let params =
            vec![serde_json::to_value(&tip_set_key)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.StateGetAllClaims", params)
            .await
    }
    ...
    async fn state_get_allocation(
        ...
        let params = vec![
            serde_json::to_value(&address).map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&allocation_id)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&tip_set_key).map_err(|e| Error::invalid_params(e.to_string()))?,
        ];
        self.client
            .request("Filecoin.StateGetAllocation", params)
            .await
    }
    ...
    async fn state_get_allocation_for_pending_deal(
        ...
        self.client
            .request("Filecoin.StateGetAllocationForPendingDeal", params)
            .await
    }
    ...
    async fn state_get_allocation_id_for_pending_deal(
        ...
        self.client
            .request("Filecoin.StateGetAllocationIdForPendingDeal", params)
            .await
    }
    ...
    async fn state_get_allocations(
        ...
        self.client
            .request("Filecoin.StateGetAllocations", params)
            .await
    }

    async fn state_get_beacon_entry(&self, chain_epoch: i64) -> Result<Option<BeaconEntry>, Error> {
        let params =
            vec![serde_json::to_value(&chain_epoch)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.StateGetBeaconEntry", params)
            .await
    }
    ...
    async fn state_get_network_params(&self) -> Result<Option<NetworkParams>, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.StateGetNetworkParams", params)
            .await
    }
    ...
    async fn state_get_randomness_digest_from_beacon(
        ...
        self.client
            .request("Filecoin.StateGetRandomnessDigestFromBeacon", params)
            .await
    }
    ...
    async fn state_get_randomness_digest_from_tickets(
        ...
        self.client
            .request("Filecoin.StateGetRandomnessDigestFromTickets", params)
            .await
    }
    ...
    async fn state_get_randomness_from_beacon(
        ...
        let params = vec![
            serde_json::to_value(&domain_separation_tag)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&chain_epoch).map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&uint8s).map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&tip_set_key).map_err(|e| Error::invalid_params(e.to_string()))?,
        ...
        self.client
            .request("Filecoin.StateGetRandomnessFromBeacon", params)
            .await
    }
    ...
    async fn state_get_randomness_from_tickets(
        ...
        self.client
            .request("Filecoin.StateGetRandomnessFromTickets", params)
            .await
    }
    ...
    async fn state_list_actors(&self, tip_set_key: Vec<Cid>) -> Result<Vec<String>, Error> {
        let params =
            vec![serde_json::to_value(&tip_set_key)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.StateListActors", params)
            .await
    }
    ...
    async fn state_list_messages(
        ...
        let params = vec![
            serde_json::to_value(&message_match)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&tip_set_key).map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&chain_epoch).map_err(|e| Error::invalid_params(e.to_string()))?,
        ];
        self.client
            .request("Filecoin.StateListMessages", params)
            .await
    }
    ...
    async fn state_list_miners(&self, tip_set_key: Vec<Cid>) -> Result<Vec<String>, Error> {
        let params =
            vec![serde_json::to_value(&tip_set_key)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.StateListMiners", params)
            .await
    }
    ...
    async fn state_lookup_robust_address(
        ...
        self.client
            .request("Filecoin.StateLookupRobustAddress", params)
            .await
    }
    ...
    async fn state_market_balance(
        ...
        self.client
            .request("Filecoin.StateMarketBalance", params)
            .await
    }
    ...
    async fn state_market_deals(
        ...
        let params =
            vec![serde_json::to_value(&tip_set_key)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.StateMarketDeals", params)
            .await
    }
    ...
    async fn state_market_participants(
        ...
        let params =
            vec![serde_json::to_value(&tip_set_key)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.StateMarketParticipants", params)
            .await
    }
    ...
    async fn state_market_storage_deal(
        ...
        self.client
            .request("Filecoin.StateMarketStorageDeal", params)
            .await
    }
    ...
    async fn state_miner_active_sectors(
        ...
        self.client
            .request("Filecoin.StateMinerActiveSectors", params)
            .await
    }
    ...
    async fn state_miner_allocated(
        ...
        self.client
            .request("Filecoin.StateMinerAllocated", params)
            .await
    }
    ...
    async fn state_miner_available_balance(
        ...
        self.client
            .request("Filecoin.StateMinerAvailableBalance", params)
            .await
    }
    ...
    async fn state_miner_deadlines(
        ...
        self.client
            .request("Filecoin.StateMinerDeadlines", params)
            .await
    }
    ...
    async fn state_miner_faults(
        ...
        self.client
            .request("Filecoin.StateMinerFaults", params)
            .await
    }
    ...
    async fn state_miner_initial_pledge_collateral(
        ...
        let params = vec![
            serde_json::to_value(&address).map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&sector_pre_commit_info)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&tip_set_key).map_err(|e| Error::invalid_params(e.to_string()))?,
        ];
        self.client
            .request("Filecoin.StateMinerInitialPledgeCollateral", params)
            .await
    }
    ...
    async fn state_miner_initial_pledge_for_sector(
        ...
        self.client
            .request("Filecoin.StateMinerInitialPledgeForSector", params)
            .await
    }
    ...
    async fn state_miner_partitions(
        ...
        self.client
            .request("Filecoin.StateMinerPartitions", params)
            .await
    }
    ...
    async fn state_miner_power(
        ...
        self.client
            .request("Filecoin.StateMinerPower", params)
            .await
    }
    ...
    async fn state_miner_pre_commit_deposit_for_power(
        ...
        self.client
            .request("Filecoin.StateMinerPreCommitDepositForPower", params)
            .await
    }
    ...
    async fn state_miner_proving_deadline(
        ...
        self.client
            .request("Filecoin.StateMinerProvingDeadline", params)
            .await
    }
    ...
    async fn state_miner_recoveries(
        ...
        self.client
            .request("Filecoin.StateMinerRecoveries", params)
            .await
    }
    ...
    async fn state_miner_sector_allocated(
        ...
        let params = vec![
            serde_json::to_value(&address).map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&sector_number)
                .map_err(|e| Error::invalid_params(e.to_string()))?,
            serde_json::to_value(&tip_set_key).map_err(|e| Error::invalid_params(e.to_string()))?,
        ];
        self.client
            .request("Filecoin.StateMinerSectorAllocated", params)
            .await
    }
    ...
    async fn state_miner_sector_count(
        ...
        self.client
            .request("Filecoin.StateMinerSectorCount", params)
            .await
    }
    ...
    async fn state_miner_sectors(
        ...
        self.client
            .request("Filecoin.StateMinerSectors", params)
            .await
    }
    ...
    async fn state_network_name(&self) -> Result<String, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.StateNetworkName", params)
            .await
    }
    ...
    async fn state_network_version(&self, tip_set_key: Vec<Cid>) -> Result<u32, Error> {
        let params =
            vec![serde_json::to_value(&tip_set_key)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.StateNetworkVersion", params)
            .await
    }
    ...
    async fn state_sector_expiration(
        ...
        self.client
            .request("Filecoin.StateSectorExpiration", params)
            .await
    }
    ...
    async fn state_sector_get_info(
        ...
        self.client
            .request("Filecoin.StateSectorGetInfo", params)
            .await
    }
    ...
    async fn state_sector_partition(
        ...
        self.client
            .request("Filecoin.StateSectorPartition", params)
            .await
    }
    ...
    async fn state_sector_pre_commit_info(
        ...
        self.client
            .request("Filecoin.StateSectorPreCommitInfo", params)
            .await
    }
    ...
    async fn state_vm_circulating_supply_internal(
        ...
        let params =
            vec![serde_json::to_value(&tip_set_key)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.StateVMCirculatingSupplyInternal", params)
            .await
    }
    ...
    async fn state_verified_client_status(
        ...
        self.client
            .request("Filecoin.StateVerifiedClientStatus", params)
            .await
    }
    ...
    async fn state_verified_registry_root_key(
        ...
        let params =
            vec![serde_json::to_value(&tip_set_key)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.StateVerifiedRegistryRootKey", params)
            .await
    }
    ...
    async fn state_verifier_status(
        ...
        self.client
            .request("Filecoin.StateVerifierStatus", params)
            .await
    }
    ...
    async fn subscribe_actor_events_raw(
        ...
        let params = vec![serde_json::to_value(&actor_event_filter)
            .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .subscribe("Filecoin.SubscribeActorEventsRaw", params)
            .await
    }
    ...
    async fn sync_checkpoint(&self, tip_set_key: Vec<Cid>) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&tip_set_key)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.SyncCheckpoint", params)
            .await
    }
    ...
    async fn sync_incoming_blocks(&self) -> Result<mpsc::Receiver<Option<BlockHeader>>, Error> {
        let params = vec![];
        self.client
            .subscribe("Filecoin.SyncIncomingBlocks", params)
            .await
    }
    ...
    async fn sync_mark_bad(&self, cid: Cid) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&cid).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.SyncMarkBad", params)
            .await
    }
    ...
    async fn sync_submit_block(&self, block_msg: Option<BlockMsg>) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&block_msg)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.SyncSubmitBlock", params)
            .await
    }
    ...
    async fn sync_unmark_all_bad(&self) -> Result<(), Error> {
        let params = vec![];
        self.client
            .request::<()>("Filecoin.SyncUnmarkAllBad", params)
            .await
    }
    ...
    async fn sync_unmark_bad(&self, cid: Cid) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&cid).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.SyncUnmarkBad", params)
            .await
    }
    ...
    async fn sync_validate_tipset(&self, tip_set_key: Vec<Cid>) -> Result<bool, Error> {
        let params =
            vec![serde_json::to_value(&tip_set_key)
                .map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.SyncValidateTipset", params)
            .await
    }
    ...
    async fn wallet_default_address(&self) -> Result<String, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.WalletDefaultAddress", params)
            .await
    }
    ...
    async fn wallet_set_default(&self, address: String) -> Result<(), Error> {
        let params =
            vec![serde_json::to_value(&address).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request::<()>("Filecoin.WalletSetDefault", params)
            .await
    }
    ...
    async fn wallet_sign_message(
        ...
        self.client
            .request("Filecoin.WalletSignMessage", params)
            .await
    }
    ...
    async fn wallet_validate_address(&self, string: String) -> Result<String, Error> {
        let params =
            vec![serde_json::to_value(&string).map_err(|e| Error::invalid_params(e.to_string()))?];
        self.client
            .request("Filecoin.WalletValidateAddress", params)
            .await
    }
    ...
    async fn web3_client_version(&self) -> Result<String, Error> {
        let params = vec![];
        self.client
            .request("Filecoin.Web3ClientVersion", params)
            .await
    }
}
